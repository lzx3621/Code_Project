...
public class AndroidNDKHelper
{
	...
	public static void SendMessageWithParameters(String methodToCall, Integer param)
	{
		JSONObject obj = new JSONObject();
		try
		{
			obj.put(__CALLED_METHOD__, methodToCall);
			obj.put(__CALLED_METHOD_PARAMS__, param);
			CPPNativeCallHandler(obj.toString());
		}
		catch (Exception e)
		{
	...
	public static void SendMessageWithParameters(String methodToCall, String param)
	{
		JSONObject obj = new JSONObject();
		try
		{
	...
	public static void SendMessageWithParameters(String methodToCall, Double param)
	{
		JSONObject obj = new JSONObject();
		try
		{
	...
	public static void SendMessageWithParameters(String methodToCall)
	{
		JSONObject obj = new JSONObject();
		try
		{
			obj.put(__CALLED_METHOD__, methodToCall);
			obj.put(__CALLED_METHOD_PARAMS__, null);
			CPPNativeCallHandler(obj.toString());
		}
		catch (Exception e)
		{
	...
	public static void RecieveCppMessage(String json)
	{
		if (json != null)
		{
			Log.v("SampleSelector", "RecieveCppMessage: " + json);
			try
			{
