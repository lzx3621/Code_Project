...
public:
    ...
    virtual cocos2d::Sprite* createRole(RoleType Type, const cocos2d::Point &pos = cocos2d::Point(0,0));
protected:
    SuperRole* createRoleOfPhysics(RoleType Type, const cocos2d::Point &pos);
